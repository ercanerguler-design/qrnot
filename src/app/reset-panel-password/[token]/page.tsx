...
export default function ResetPanelPasswordPage() {
    ...
    <div className="min-h-screen bg-neutral-950 px-4 py-12">
      <div className="max-w-md mx-auto">
        ...
        <div className="mt-8 bg-neutral-900 border border-neutral-800 rounded-3xl p-6">
          <h1 className="text-2xl font-bold text-white mb-3">Panel Şifreni Yenile</h1>
          <p className="text-neutral-400 text-sm mb-6">
            Admin tarafından gönderilen link ile panel giriş şifreni güncelleyebilirsin.
          </p>

          {done ? (
            <div className="bg-green-950/40 border border-green-800 text-green-300 text-sm px-4 py-3 rounded-2xl">
              Şifre güncellendi. Artık paneline yeni şifre ile giriş yapabilirsin.
            </div>
          ) : (
